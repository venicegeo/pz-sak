...
(function(){
    ...
    angular
        .module('SAKapp')
        .controller('LoginController', ['$scope', '$location', '$rootScope', "$http", "discover", "toaster", "Auth", LoginController]);

    function LoginController ($scope, $location, $rootScope, $http, discover, toaster, Auth) {
        $scope.auth = Auth;
